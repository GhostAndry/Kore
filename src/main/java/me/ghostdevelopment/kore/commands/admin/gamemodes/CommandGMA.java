...
public class CommandGMA implements CommandExecutor {
    ...
    Kore plugin;
    public CommandGMA(Kore plugin){this.plugin=plugin;}
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(args.length==0){
            ...
            target.sendMessage(Utils.Color(plugin.getConfig().getString("gamemode.adventure-changed").replaceAll("%prefix%", plugin.getConfig().getString("messages.prefix"))));
