...
public class CommandGMS implements CommandExecutor {
    ...
    Kore plugin;
    public CommandGMS(Kore plugin){this.plugin=plugin;}
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length==0){
            ...
            target.sendMessage(Utils.Color(plugin.getConfig().getString("gamemode.survival-changed").replaceAll("%prefix%", plugin.getConfig().getString("messages.prefix"))));
